...
@ObjectType('AuthCrudresponse', { description: 'Response for CRUD action for Users' })
export class AuthCrudresponse extends GeneralResponse {
	@Field({ nullable: true })
	id: string;
}

@ObjectType('LoginResponse', { description: 'Data for authentication' })
